...
from database.models import Base, Refund
...
class Payment(Base):
    ...
    created_date: Mapped[datetime.datetime] = mapped_column(DateTime, default=datetime.datetime.now, nullable=False, comment="Дата создания записи о платеже")
    ...
    payed_date: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=True, comment="Дата фактической оплаты")
