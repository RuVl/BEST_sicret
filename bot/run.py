...
async def main():
    ...
    await bot.set_my_commands([
        ...
        BotCommand(command='property_database', description='База имущества'),
        BotCommand(command='request_refund', description='Запросить рефанд')
    ])
    ...
    register_middlewares(dp, dialogs_router)
