...
something-went-wrong = Что-то пошло не так, свяжитесь с администратором
...
input-type-incorrect = Неверный тип данных, ожидается { $type }
format-type-incorrect = Неверный формат данных\!
generate-document = Сгенерировать документ
array-item = Элемент массива
