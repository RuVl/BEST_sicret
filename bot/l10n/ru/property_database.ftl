# Property Database localization

# Main menu (moved from main.ftl)
...
application-form-instruction-name = 1\. Ваше имя
application-form-instruction-purpose = 2\. Цель взятия
application-form-instruction-items = 3\. Выберите предметы и их количество

# Fields
field-applicant-name = Имя
field-purpose = Цель
